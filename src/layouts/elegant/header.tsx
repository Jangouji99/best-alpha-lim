...
function Header({ lang }: { lang: string }) {
  ...
  return (
    ...
    >
      <div className="z-20 w-full transition-all duration-200 ease-in-out innerSticky lg:w-full body-font bg-brand-light">
        <Search
        ...
        <Container className="flex items-center justify-between h-16 py-3 border-b top-bar lg:h-auto border-border-base">
          <div className="relative shrink-0 lg:hidden" ref={categoryBtnRef}>
            <button
            ...
            {categoryMenu && (
              <CategoryDropdownMenu lang={lang} className="mt-3 md:mt-2.5" />
            )}
          </div>
          {/* End of Category */}

          <Logo className="logo -mt-1.5 md:-mt-1 md:mx-auto ltr:pl-3 rtl:pr-3 md:ltr:pl-0 md:rtl:pr-0 lg:mx-0" lang={lang || 'zh'} />
          {/* End of logo */}
          <Search
        ...
        <div className="hidden navbar lg:block bg-brand-light">
          <Container className="h-20 flex justify-between items-center py-2.5">
            <Logo className="!w-0 transition-all duration-200 ease-in-out opacity-0 navbar-logo" lang={lang || 'zh'} />
            {/* End of logo */}
