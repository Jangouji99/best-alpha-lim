...
function Header({ lang }: { lang: string }) {
  ...
  useActiveScroll(siteHeaderRef, 10);
  ...
  return (
    ...
    >
      <div className="absolute z-30 w-full transition duration-200 ease-in-out innerSticky lg:fixed lg:w-full body-font bg-brand-light">
        <Search
        ...
        >
          <div className="flex items-center">
            ...
            <Logo className="-mt-1 logo" lang={lang} />
            {/* End of logo */}
