...
const ProductFlashSaleCoral: React.FC<ProductProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto font-semibold justify-center flex flex-row space-x-1  md-1">
        {units?.map((unit) => (
          <div key={unit.id} className="flex items-center space-x-1">
            <span className="flex items-center px-5 justify-center min-w-[40px] md:min-w-[50px] min-h-[36px] md:min-h-[40px] bg-fill-three text-brand-dark rounded p-1 mx-1 md:mx-1.5 lg:mx-2.5">
...
export default ProductFlashSaleCoral;
