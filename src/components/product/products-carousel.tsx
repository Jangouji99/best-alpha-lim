...
const ProductsCarousel: React.FC<ProductsCarouselProps> = ({
  ...
  function closeModalSeeAll() {
    closeModal();
  }
  return (
    <div
      className={cn(
        'max-w-[1920px] lg:mt-9 overflow-hidden 4xl:overflow-visible px-4 md:px-6 lg:px-8 2xl:ltr:pl-10 2xl:rtl:pr-10 2xl:ltr:pr-0 2xl:rtl:pl-0 4xl:ltr:pr-10 4xl:rtl:pl-10 mx-auto relative',
        className,
      )}
    >
          ...
          >
            {loading && !products?.length ? (
              ...
              <>
                ...
                <SwiperSlide onClick={closeModalSeeAll} className="p-2.5 flex items-center justify-center">
                  <SeeAll href={`/products`} lang={lang} />
                </SwiperSlide>
