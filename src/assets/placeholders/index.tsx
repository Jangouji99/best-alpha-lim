...
export { default as productGalleryPlaceholder } from '@assets/placeholders/product-placeholder.jpg';
export { default as orderNotfound } from '@assets/placeholders/order-notfound.png';
